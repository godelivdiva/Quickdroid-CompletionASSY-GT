...
public class ProcessSerialActivity extends AppCompatActivity {
...
//                    Toast.makeText(MainActivity.this, "silahkan pilih from subinventory", Toast.LENGTH_SHORT).show();
                    ...
                    if(i==1){ //pilih OK
                        ...
                        ArrayAdapter<String> adapter = new ArrayAdapter<String>(
                                ProcessSerialActivity.this, android.R.layout.simple_spinner_dropdown_item, list_loc);
    ...
    void processCompletion() {
        sweetAlertDialog = new SweetAlertDialog(ProcessSerialActivity.this, SweetAlertDialog.PROGRESS_TYPE);
    ...
    public void alertSuccess() {
        ...
        sweetAlertDialog = new SweetAlertDialog(ProcessSerialActivity.this, SweetAlertDialog.SUCCESS_TYPE)
...
//                tv_locName.setText(locName);
    ...
    void insertToInterface(String serial){
        ...
        try {
            ...
            mQuery = "insert into mtl_serial_numbers_interface \n" +
                    "(TRANSACTION_INTERFACE_ID, \n" +
                    "SOURCE_CODE, \n" +
                    "SOURCE_LINE_ID, \n" +
                    "LAST_UPDATE_DATE, \n" +
                    ...
                    "ERROR_CODE, \n" +
                    "PROCESS_FLAG) \n" +
                    "values("+trasactionInterfaceId+", \n" +
                    "'COMPLETION-SERIAL', -- Source Code \n" +
                    "1, -- Source Line id \n" +
                    "sysdate, --Last Update date \n" +
                    userId+", -- Last updated by \n" +
                    "sysdate, --Creastion date \n" +
                    userId+", --Created by \n" +
                    userId+", -- Last update login \n" +
                    "'"+serial+"', -- FM_SERIAL_NUMBER \n" +
                    "'"+serial+"', -- TO_SERIAL_NUMBER \n" +
                    "NULL, --Error code \n" +
                    "1 --Process Flag \n" +
                    ")";
            Log.d("mQuery", mQuery);
